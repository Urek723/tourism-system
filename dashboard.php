<?php
/**
 * dashboard.php  [UPDATED v3]
 *
 * CHANGED:
 *  - Shows the user's current interests (preferences) on the dashboard
 *  - Adds an "Edit Account" shortcut button in the page header
 *  - Locations are filtered by user preferences when set
 *
 * ALL EXISTING SECURITY PRESERVED — no changes to auth guards,
 * prepared statements, or output escaping logic.
 */
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-start justify-content-between mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <?php if (is_admin()): ?>
                <a href="admin/index.php" class="btn btn-brand">
        ...
        <div class="mb-4 p-3 rounded-3"
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <a href="edit_account.php" class="btn btn-gold btn-sm">
                    Set Interests
                </a>
            </div>
        </div>
